...
\acrshort{aslr} ist leider wie in \autoref{sec:explainersub} dargestellt nicht effektiv, wenn der Angreifer
...
wird \acrshort{aslr}  nicht verwendet. \cite{aslrandrew} In neueren Distributionen ist \acrshort{aslr} 
standardmäßig eingeschaltet.

\newacronym{pie}{PIE}{Position Independent Executable}
Compiler haben ein Pendant zu \acrshort{aslr} welches \acrlong{pie} oder kurz \acrshort{pie}
